...
$t$의 구간들 $[l_i, r_i]$이 $N$개 주어질 때, $t$가 모든 구간들의 합집합 내에 있을 때, 가능한 서로 다른 순서쌍 $(x, y)$의 개수를 구하여라.

### 제한
$N \leq 10^6$, $1 \leq A, B \leq 10^{18}$  
...
$0$을 기준으로 원형 구간들을 모두 쪼개고, 전체 구간들을 정렬한 후 sweeping을 통해 합집합의 크기를 구할 수 있다.
